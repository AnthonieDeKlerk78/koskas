-- Migration to add calories, contents, and image_url fields to ingredients table
-- Also creates storage bucket for ingredient images
-- Run this in your Supabase SQL Editor

-- Step 1: Add new columns to ingredients table
...
COMMENT ON COLUMN ingredients.calories IS 'Calorie content per unit/serving';
COMMENT ON COLUMN ingredients.contents IS 'Array of ingredient components (e.g., sugar, oil, cocoa for chocolate)';
